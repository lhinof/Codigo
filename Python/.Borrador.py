...
class Evaluacion:
    ...
    def mostrar(self):
        print(f"{self.nom:<10} {self.pat:<10} {self.mat:<10} {self.primer_parcial:>3} {self.segundo_parcial:>3} {self.examen_final:>3} {self.auxiliatura:>3} {self.practicas:>3} {self.nota_total():>3}")
